...
html_report = generate_ariae_html_report(comparison, 'LUMIERE_001_0000.nii.gz', 'LUMIERE_002_0000.nii.gz', 'LUMIERE_001.nii.gz')
with open("lesion_report_improved2.html", "w") as f:
    f.write(html_report)
